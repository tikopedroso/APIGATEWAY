...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\hawk\\README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h2">
        <a href="#protocol-example">Protocol Example</a>
      </div>

      <div class="heading h3">
        <a href="#payload-validation">Payload Validation</a>
      </div>

      <div class="heading h2">
        <a href="#response-payload-validation">Response Payload Validation</a>
      </div>

      <div class="heading h2">
        <a href="#browser-support-and-considerations">Browser Support and Considerations</a>
      </div>

      <div class="heading h1">
        <a href="#single-uri-authorization">Single URI Authorization</a>
      </div>

      <div class="heading h2">
        <a href="#bewit-usage-example">Bewit Usage Example</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#mac-keys-transmission">MAC Keys Transmission</a>
      </div>

      <div class="heading h3">
        <a href="#confidentiality-of-requests">Confidentiality of Requests</a>
      </div>

      <div class="heading h3">
        <a href="#spoofing-by-counterfeit-servers">Spoofing by Counterfeit Servers</a>
      </div>

      <div class="heading h3">
        <a href="#plaintext-storage-of-credentials">Plaintext Storage of Credentials</a>
      </div>

      <div class="heading h3">
        <a href="#entropy-of-keys">Entropy of Keys</a>
      </div>

      <div class="heading h3">
        <a href="#coverage-limitations">Coverage Limitations</a>
      </div>

      <div class="heading h3">
        <a href="#future-time-manipulation">Future Time Manipulation</a>
      </div>

      <div class="heading h3">
        <a href="#client-clock-poisoning">Client Clock Poisoning</a>
      </div>

      <div class="heading h3">
        <a href="#bewit-limitations">Bewit Limitations</a>
      </div>

      <div class="heading h3">
        <a href="#host-header-forgery">Host Header Forgery</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#where-is-the-protocol-specification">Where is the protocol specification?</a>
      </div>

      <div class="heading h3">
        <a href="#is-it-done">Is it done?</a>
      </div>

      <div class="heading h3">
        <a href="#where-can-i-find-hawk-implementations-in-other-languages">Where can I find Hawk implementations in other languages?</a>
      </div>

      <div class="heading h3">
        <a href="#why-isnt-the-algorithm-part-of-the-challenge-or-dynamically-negotiated">Why isn&#39;t the algorithm part of the challenge or dynamically negotiated?</a>
      </div>

      <div class="heading h3">
        <a href="#why-is-host-and-content-type-the-only-headers-covered-by-the-request-mac">Why is Host and Content-Type the only headers covered by the request MAC?</a>
      </div>

      <div class="heading h3">
        <a href="#why-not-just-use-http-digest">Why not just use HTTP Digest?</a>
      </div>

      <div class="heading h3">
        <a href="#why-bother-with-all-this-nonce-and-timestamp-business">Why bother with all this nonce and timestamp business?</a>
      </div>

      <div class="heading h3">
        <a href="#what-are-app-and-dlg-in-the-authorization-header-and-normalized-mac-string">What are app and dlg in the authorization header and normalized mac string?</a>
      </div>

      <div class="heading h3">
        <a href="#what-is-the-purpose-of-the-static-strings-used-in-each-normalized-mac-input">What is the purpose of the static strings used in each normalized MAC input?</a>
      </div>

      <div class="heading h3">
        <a href="#does-hawk-have-anything-to-do-with-oauth">Does Hawk have anything to do with OAuth?</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><p><img src="https://raw.github.com/hueniverse/hawk/master/images/hawk.png" alt="hawk Logo"></p>
...
<div class="pilwrap" id="table-of-content">
  <h1>
    <a href="#table-of-content" name="table-of-content" class="pilcrow"></a>
Table of Content
  </h1>
</div>
<ul>
...
<ul>
<li><a href="#replay-protection.html">Replay Protection</a></li>
<li><a href="#usage-example.html">Usage Example</a></li>
<li><a href="#protocol-example.html">Protocol Example</a>
<ul>
<li><a href="#payload-validation.html">Payload Validation</a></li>
<li><a href="#response-payload-validation.html">Response Payload Validation</a></li>
</ul>
</li>
<li><a href="#browser-support-and-considerations.html">Browser Support and Considerations</a></li>
</ul>
</li>
</ul>
<p></p>
...
<p>The primary design goals of this scheme are to:</p>
<ul>
<li>simplify and improve HTTP authentication for services that are unwilling or unable to deploy TLS for all resources,</li>
<li>secure credentials against leakage (e.g., when the client uses some form of dynamic configuration to determine where
to send an authenticated request), and</li>
...
and the server.</p>
<div class="pilwrap" id="replay-protection">
  <h2>
    <a href="#replay-protection" name="replay-protection" class="pilcrow"></a>
Replay Protection
  </h2>
</div>
...
<div class="pilwrap" id="usage-example">
  <h2>
    <a href="#usage-example" name="usage-example" class="pilcrow"></a>
Usage Example
  </h2>
</div>
<p>Server code:</p>
...
<span class="hljs-keyword">var</span> Hawk = <span class="hljs-built_in">require</span>(<span class="hljs-string">'hawk'</span>);


<span class="hljs-comment">// Credentials lookup function</span>
...
<span class="hljs-keyword">var</span> handler = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">req, res</span>) </span>{

    <span class="hljs-comment">// Authenticate incoming request</span>

    Hawk.server.authenticate(req, credentialsFunc, {}, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">err, credentials, artifacts</span>) </span>{

        <span class="hljs-comment">// Prepare response</span>

        <span class="hljs-keyword">var</span> payload = (!err ? <span class="hljs-string">'Hello '</span> + credentials.user + <span class="hljs-string">' '</span> + artifacts.ext : <span class="hljs-string">'Shoosh!'</span>);
        <span class="hljs-keyword">var</span> headers = { <span class="hljs-string">'Content-Type'</span>: <span class="hljs-string">'text/plain'</span> };

        <span class="hljs-comment">// Generate Server-Authorization response header</span>

        <span class="hljs-keyword">var</span> header = Hawk.server.header(credentials, artifacts, { <span class="hljs-attr">payload</span>: payload, <span class="hljs-attr">contentType</span>: headers[<span class="hljs-string">'Content-Type'</span>] });
        headers[<span class="hljs-string">'Server-Authorization'</span>] = header;

        <span class="hljs-comment">// Send the response back</span>

        res.writeHead(!err ? <span class="hljs-number">200</span> : <span class="hljs-number">401</span>, headers);
        res.end(payload);
    });
};
...
Http.createServer(handler).listen(<span class="hljs-number">8000</span>, <span class="hljs-string">'example.com'</span>);
</code></pre>
<p>Client code:</p>
<pre><code class="javascript"><span class="hljs-keyword">var</span> Request = <span class="hljs-built_in">require</span>(<span class="hljs-string">'request'</span>);
<span class="hljs-keyword">var</span> Hawk = <span class="hljs-built_in">require</span>(<span class="hljs-string">'hawk'</span>);


<span class="hljs-comment">// Client credentials</span>

<span class="hljs-keyword">var</span> credentials = {
    <span class="hljs-attr">id</span>: <span class="hljs-string">'dh37fgj492je'</span>,
    <span class="hljs-attr">key</span>: <span class="hljs-string">'werxhqb98rpaxn39848xrunpaw3489ruxnpa98w4rxn'</span>,
    <span class="hljs-attr">algorithm</span>: <span class="hljs-string">'sha256'</span>
}
...
<span class="hljs-keyword">var</span> requestOptions = {
    <span class="hljs-attr">uri</span>: <span class="hljs-string">'http://example.com:8000/resource/1?b=1&amp;a=2'</span>,
    <span class="hljs-attr">method</span>: <span class="hljs-string">'GET'</span>,
    <span class="hljs-attr">headers</span>: {}
};

<span class="hljs-comment">// Generate Authorization request header</span>

<span class="hljs-keyword">var</span> header = Hawk.client.header(<span class="hljs-string">'http://example.com:8000/resource/1?b=1&amp;a=2'</span>, <span class="hljs-string">'GET'</span>, { <span class="hljs-attr">credentials</span>: credentials, <span class="hljs-attr">ext</span>: <span class="hljs-string">'some-app-data'</span> });
requestOptions.headers.Authorization = header.field;

<span class="hljs-comment">// Send authenticated request</span>

Request(requestOptions, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">error, response, body</span>) </span>{

    <span class="hljs-comment">// Authenticate the server's response</span>

    <span class="hljs-keyword">var</span> isValid = Hawk.client.authenticate(response, credentials, header.artifacts, { <span class="hljs-attr">payload</span>: body });

    <span class="hljs-comment">// Output results</span>

    <span class="hljs-built_in">console</span>.log(response.statusCode + <span class="hljs-string">': '</span> + body + (isValid ? <span class="hljs-string">' (valid)'</span> : <span class="hljs-string">' (invalid)'</span>));
});
</code></pre>
...
<pre><code class="javascript">Hawk.sntp.start();
</code></pre>
<div class="pilwrap" id="protocol-example">
  <h2>
    <a href="#protocol-example" name="protocol-example" class="pilcrow"></a>
Protocol Example
  </h2>
</div>
...
<pre><code>6R4rV5iE+NPoym+WwjeHzjAGXUtLNIxmo1vpMofpLAE=
</code></pre>
...
<div class="pilwrap" id="payload-validation">
  <h3>
    <a href="#payload-validation" name="payload-validation" class="pilcrow"></a>
Payload Validation
  </h3>
</div>
...
<li>the request payload prior to any content encoding (the exact representation requirements should be specified by the server for payloads other than simple single-part ascii to ensure interoperability)</li>
</ul>
<p>For example:</p>
<ul>
...
<pre><code>POST /resource/1?a=1&amp;b=2 HTTP/1.1
Host: example.com:8000
...
<div class="pilwrap" id="response-payload-validation">
  <h2>
    <a href="#response-payload-validation" name="response-payload-validation" class="pilcrow"></a>
...
<div class="pilwrap" id="browser-support-and-considerations">
  <h2>
    <a href="#browser-support-and-considerations" name="browser-support-and-considerations" class="pilcrow"></a>
Browser Support and Considerations
  </h2>
</div>
<p>A browser script is provided for including using a <code>&lt;script&gt;</code> tag in <a href="/lib/browser.js.html">lib/browser.js</a>. It's also a <a href="http://component.io/hueniverse/hawk">component</a>.</p>
...
<div class="pilwrap" id="single-uri-authorization">
  <h1>
    <a href="#single-uri-authorization" name="single-uri-authorization" class="pilcrow"></a>
...
<div class="pilwrap" id="bewit-usage-example">
  <h2>
    <a href="#bewit-usage-example" name="bewit-usage-example" class="pilcrow"></a>
Bewit Usage Example
  </h2>
</div>
<p>Server code:</p>
...
<span class="hljs-keyword">var</span> handler = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">req, res</span>) </span>{
    ...
    Hawk.uri.authenticate(req, credentialsFunc, {}, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">err, credentials, attributes</span>) </span>{
        ...
        res.writeHead(!err ? <span class="hljs-number">200</span> : <span class="hljs-number">401</span>, { <span class="hljs-string">'Content-Type'</span>: <span class="hljs-string">'text/plain'</span> });
        res.end(!err ? <span class="hljs-string">'Access granted'</span> : <span class="hljs-string">'Shoosh!'</span>);
    });
};
...
<span class="hljs-comment">// Generate bewit</span>

<span class="hljs-keyword">var</span> duration = <span class="hljs-number">60</span> * <span class="hljs-number">5</span>;      <span class="hljs-comment">// 5 Minutes</span>
<span class="hljs-keyword">var</span> bewit = Hawk.uri.getBewit(<span class="hljs-string">'http://example.com:8080/resource/1?b=1&amp;a=2'</span>, { <span class="hljs-attr">credentials</span>: credentials, <span class="hljs-attr">ttlSec</span>: duration, <span class="hljs-attr">ext</span>: <span class="hljs-string">'some-app-data'</span> });
<span class="hljs-keyword">var</span> uri = <span class="hljs-string">'http://example.com:8000/resource/1?b=1&amp;a=2'</span> + <span class="hljs-string">'&amp;bewit='</span> + bewit;
</code></pre>
...
<div class="pilwrap" id="mac-keys-transmission">
  <h3>
    <a href="#mac-keys-transmission" name="mac-keys-transmission" class="pilcrow"></a>
...
<div class="pilwrap" id="confidentiality-of-requests">
  <h3>
    <a href="#confidentiality-of-requests" name="confidentiality-of-requests" class="pilcrow"></a>
...
<div class="pilwrap" id="spoofing-by-counterfeit-servers">
  <h3>
    <a href="#spoofing-by-counterfeit-servers" name="spoofing-by-counterfeit-servers" class="pilcrow"></a>
...
<div class="pilwrap" id="plaintext-storage-of-credentials">
  <h3>
    <a href="#plaintext-storage-of-credentials" name="plaintext-storage-of-credentials" class="pilcrow"></a>
...
access.</p>
<div class="pilwrap" id="entropy-of-keys">
  <h3>
    <a href="#entropy-of-keys" name="entropy-of-keys" class="pilcrow"></a>
Entropy of Keys
  </h3>
</div>
...
<div class="pilwrap" id="coverage-limitations">
  <h3>
    <a href="#coverage-limitations" name="coverage-limitations" class="pilcrow"></a>
...
<div class="pilwrap" id="future-time-manipulation">
  <h3>
    <a href="#future-time-manipulation" name="future-time-manipulation" class="pilcrow"></a>
...
<div class="pilwrap" id="client-clock-poisoning">
  <h3>
    <a href="#client-clock-poisoning" name="client-clock-poisoning" class="pilcrow"></a>
...
<div class="pilwrap" id="bewit-limitations">
  <h3>
    <a href="#bewit-limitations" name="bewit-limitations" class="pilcrow"></a>
Bewit Limitations
  </h3>
</div>
...
<div class="pilwrap" id="host-header-forgery">
  <h3>
    <a href="#host-header-forgery" name="host-header-forgery" class="pilcrow"></a>
Host Header Forgery
  </h3>
</div>
...
<div class="pilwrap" id="frequently-asked-questions">
  <h1>
    <a href="#frequently-asked-questions" name="frequently-asked-questions" class="pilcrow"></a>
Frequently Asked Questions
  </h1>
</div>
<div class="pilwrap" id="where-is-the-protocol-specification">
  <h3>
    <a href="#where-is-the-protocol-specification" name="where-is-the-protocol-specification" class="pilcrow"></a>
...
project instead of a standard. In other words, the <a href="/hueniverse/hawk/tree/master/lib.html">code</a> is the specification. Not sure about
something? Open an issue!</p>
<div class="pilwrap" id="is-it-done">
  <h3>
    <a href="#is-it-done" name="is-it-done" class="pilcrow"></a>
Is it done?
  </h3>
</div>
...
and suggestions.</p>
<div class="pilwrap" id="where-can-i-find-hawk-implementations-in-other-languages">
  <h3>
    <a href="#where-can-i-find-hawk-implementations-in-other-languages" name="where-can-i-find-hawk-implementations-in-other-languages" class="pilcrow"></a>
Where can I find <strong>Hawk</strong> implementations in other languages?
  </h3>
</div>
...
<div class="pilwrap" id="why-isnt-the-algorithm-part-of-the-challenge-or-dynamically-negotiated">
  <h3>
    <a href="#why-isnt-the-algorithm-part-of-the-challenge-or-dynamically-negotiated" name="why-isnt-the-algorithm-part-of-the-challenge-or-dynamically-negotiated" class="pilcrow"></a>
...
<div class="pilwrap" id="why-is-host-and-content-type-the-only-headers-covered-by-the-request-mac">
  <h3>
    <a href="#why-is-host-and-content-type-the-only-headers-covered-by-the-request-mac" name="why-is-host-and-content-type-the-only-headers-covered-by-the-request-mac" class="pilcrow"></a>
...
<div class="pilwrap" id="why-not-just-use-http-digest">
  <h3>
    <a href="#why-not-just-use-http-digest" name="why-not-just-use-http-digest" class="pilcrow"></a>
...
<div class="pilwrap" id="why-bother-with-all-this-nonce-and-timestamp-business">
  <h3>
    <a href="#why-bother-with-all-this-nonce-and-timestamp-business" name="why-bother-with-all-this-nonce-and-timestamp-business" class="pilcrow"></a>
...
<div class="pilwrap" id="what-are-app-and-dlg-in-the-authorization-header-and-normalized-mac-string">
  <h3>
    <a href="#what-are-app-and-dlg-in-the-authorization-header-and-normalized-mac-string" name="what-are-app-and-dlg-in-the-authorization-header-and-normalized-mac-string" class="pilcrow"></a>
What are <code>app</code> and <code>dlg</code> in the authorization header and normalized mac string?
  </h3>
</div>
...
<div class="pilwrap" id="what-is-the-purpose-of-the-static-strings-used-in-each-normalized-mac-input">
  <h3>
    <a href="#what-is-the-purpose-of-the-static-strings-used-in-each-normalized-mac-input" name="what-is-the-purpose-of-the-static-strings-used-in-each-normalized-mac-input" class="pilcrow"></a>
...
<div class="pilwrap" id="does-hawk-have-anything-to-do-with-oauth">
  <h3>
    <a href="#does-hawk-have-anything-to-do-with-oauth" name="does-hawk-have-anything-to-do-with-oauth" class="pilcrow"></a>
Does <strong>Hawk</strong> have anything to do with OAuth?
  </h3>
</div>
<p>Short answer: no.</p>
