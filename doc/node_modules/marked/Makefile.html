...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\marked\\Makefile";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="makefile"><span class="hljs-section">all:</span>
...
<span class="hljs-section">bench:</span>
	@node test --bench

<span class="hljs-section">man/marked.1.txt:</span>
