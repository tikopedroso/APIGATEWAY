...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\typechecker\\README.md";
  ...
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#typechecker">TypeChecker</a>
      </div>
...
<div class="pilwrap" id="typechecker">
  <h1>
    <a href="#typechecker" name="typechecker" class="pilcrow"></a>
TypeChecker
  </h1>
</div>
<!-- /TITLE -->
<!-- BADGES/ -->
<p><span class="badge-travisci"><a href="http://travis-ci.com/bevry/typechecker" title="Check this project's build status on TravisCI"><img src="https://img.shields.io/travis/com/bevry/typechecker/master.svg" alt="Travis CI Build Status" /></a></span>
...
<!-- /BADGES -->
<!-- DESCRIPTION/ -->
<p>Utilities to get and check variable types (isString, isPlainObject, isRegExp, etc)</p>
<!-- /DESCRIPTION -->
...
<p>Why should I use this instead of say <code>instanceof</code>?</p>
<p>Under certain circumstances <code>instanceof</code> may not return the correct results. This occurs with <a href="http://nodejs.org/api/vm.html#vm_globals">node's vm module</a> especially, and circumstances where an object's prototype has been dereferenced from the original. As such, for basic <code>==</code> and <code>===</code> checks (like <code>a === null</code>), you're fine not using this, but for checks when you would have done <code>instanceof</code> (like <code>err instanceof Error</code>), you should try to use this instead. Plus things like <code>isEmpty</code>, <code>isEmptyObject</code> and <code>isPlainObject</code> are darn useful!</p>
...
<p><a href="http://master.typechecker.bevry.surge.sh/docs/">API Documentation</a></p>
<!-- INSTALL/ -->
...
<pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"module"</span>&gt;</span><span class="javascript">
    <span class="hljs-keyword">import</span> * <span class="hljs-keyword">as</span> pkg <span class="hljs-keyword">from</span> <span class="hljs-string">'//dev.jspm.io/typechecker'</span>
...
<p><a href="https://github.com/bevry/typechecker/blob/master/HISTORY.md#files">Discover the release history by heading on over to the <code>HISTORY.md</code> file.</a></p>
<!-- /HISTORY -->
<!-- CONTRIBUTE/ -->
...
<p><a href="https://github.com/bevry/typechecker/blob/master/CONTRIBUTING.md#files">Discover how you can contribute by heading on over to the <code>CONTRIBUTING.md</code> file.</a></p>
<!-- /CONTRIBUTE -->
<!-- BACKERS/ -->
