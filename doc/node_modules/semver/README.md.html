...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\semver\\README.md";
...
<pre><code class="bash">npm install semver
</code></pre>
...
<pre><code class="js"><span class="hljs-keyword">const</span> semver = <span class="hljs-built_in">require</span>(<span class="hljs-string">'semver'</span>)
...
<div class="pilwrap" id="comparators">
  <h3>
    <a href="#comparators" name="comparators" class="pilcrow"></a>
Comparators
  </h3>
</div>
<ul>
