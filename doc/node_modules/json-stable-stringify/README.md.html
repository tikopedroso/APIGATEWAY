...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\json-stable-stringify\\README.md";
...
json-stable-stringify <sup><a href="https://npmjs.org/package/json-stable-stringify"><img src="https://versionbadg.es/ljharb/json-stable-stringify.svg" alt="Version Badge"></a></sup>
  </h1>
</div>
<p><a href="https://github.com/ljharb/json-stable-stringify/actions"><img src="https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/ljharb/json-stable-stringify" alt="github actions"></a>
<a href="https://app.codecov.io/gh/ljharb/json-stable-stringify/"><img src="https://codecov.io/gh/ljharb/json-stable-stringify/branch/main/graphs/badge.svg" alt="coverage"></a>
<a href="LICENSE.html"><img src="https://img.shields.io/npm/l/json-stable-stringify.svg" alt="License"></a>
<a href="https://npm-stat.com/charts.html?package=json-stable-stringify"><img src="https://img.shields.io/npm/dm/json-stable-stringify.svg" alt="Downloads"></a></p>
<p><a href="https://npmjs.org/package/json-stable-stringify"><img src="https://nodei.co/npm/json-stable-stringify.png?downloads=true&amp;stars=true" alt="npm badge"></a></p>
<p>deterministic version of <code>JSON.stringify()</code> so you can get a consistent hash from stringified results</p>
<p>You can also pass in a custom comparison function.</p>
<p><a href="https://ci.testling.com/ljharb/json-stable-stringify"><img src="https://ci.testling.com/ljharb/json-stable-stringify.png" alt="browser support"></a></p>
<p><a href="http://travis-ci.org/ljharb/json-stable-stringify"><img src="https://secure.travis-ci.org/ljharb/json-stable-stringify.png" alt="build status"></a></p>
...
<p>If <code>opts</code> is given, you can supply an <code>opts.cmp</code> to have a custom comparison function for object keys.
Your function <code>opts.cmp</code> is called with these parameters:</p>
...
<span class="hljs-keyword">var</span> s = stringify(obj, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">a, b</span>) </span>{
	<span class="hljs-keyword">return</span> b.key.localeCompare(a.key);
});
...
<p>The replacer parameter is a function <code>opts.replacer(key, value)</code> that behaves the same as the replacer
