...
<p>check alias of sub commands</p>
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._execs[name] === <span class="hljs-literal">true</span>) {
...
subcommand file should be located at</p>
  ...
  <span class="hljs-keyword">var</span> resolvedLink = fs.realpathSync(f);
