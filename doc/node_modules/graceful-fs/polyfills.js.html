...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\graceful-fs\\polyfills.js";
...
<p>This check is needed until node.js 12 is required</p>

        </td>
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> process.chdir === <span class="hljs-string">'function'</span>) {
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-built_in">Object</span>.setPrototypeOf) <span class="hljs-built_in">Object</span>.setPrototypeOf(process.chdir, chdir)
}
...
<p>if lchmod/lchown do not exist, then make them no-ops</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (fs.chmod &amp;&amp; !fs.lchmod) {
  ...
  <span class="hljs-keyword">if</span> (fs.chown &amp;&amp; !fs.lchown) {
...
contention to be starved of CPU by node, so the contention doesn't resolve.</p>
    ...
    fs.rename = <span class="hljs-keyword">typeof</span> fs.rename !== <span class="hljs-string">'function'</span> ? fs.rename
    : (<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fs$rename</span>) </span>{
      <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">rename</span> (<span class="hljs-params">from, to, cb</span>) </span>{
        ...
        fs$rename(<span class="hljs-keyword">from</span>, to, <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">CB</span> (<span class="hljs-params">er</span>) </span>{
          <span class="hljs-keyword">if</span> (er
              &amp;&amp; (er.code === <span class="hljs-string">"EACCES"</span> || er.code === <span class="hljs-string">"EPERM"</span> || er.code === <span class="hljs-string">"EBUSY"</span>)
      ...
      <span class="hljs-keyword">if</span> (<span class="hljs-built_in">Object</span>.setPrototypeOf) <span class="hljs-built_in">Object</span>.setPrototypeOf(rename, fs$rename)
      <span class="hljs-keyword">return</span> rename
    })(fs.rename)
  }
...
<p>if read() returns EAGAIN, then just try it again.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  fs.read = <span class="hljs-keyword">typeof</span> fs.read !== <span class="hljs-string">'function'</span> ? fs.read
  : (<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fs$read</span>) </span>{
...
<p>This ensures <code>util.promisify</code> works as it does for native <code>fs.read</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (<span class="hljs-built_in">Object</span>.setPrototypeOf) <span class="hljs-built_in">Object</span>.setPrototypeOf(read, fs$read)
    <span class="hljs-keyword">return</span> read
  })(fs.read)

  fs.readSync = <span class="hljs-keyword">typeof</span> fs.readSync !== <span class="hljs-string">'function'</span> ? fs.readSync
  : (<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fs$readSync</span>) </span>{ <span class="hljs-keyword">return</span> <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">fd, buffer, offset, length, position</span>) </span>{
    <span class="hljs-keyword">var</span> eagCounter = <span class="hljs-number">0</span>
...
but still try to close, and report closing errors if they occur.</p>
  ...
  <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">patchLutimes</span> (<span class="hljs-params">fs</span>) </span>{
    <span class="hljs-keyword">if</span> (constants.hasOwnProperty(<span class="hljs-string">"O_SYMLINK"</span>) &amp;&amp; fs.futimes) {
    ...
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (fs.futimes) {
