...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\graceful-fs\\README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h2">
        <a href="#sync-methods">Sync methods</a>
      </div>
...
fs.readFile(<span class="hljs-string">'some-file-or-whatever'</span>, (err, data) =&gt; {
  <span class="hljs-comment">// Do stuff here.</span>
})
</code></pre>
<div class="pilwrap" id="sync-methods">
  <h2>
    <a href="#sync-methods" name="sync-methods" class="pilcrow"></a>
Sync methods
  </h2>
</div>
