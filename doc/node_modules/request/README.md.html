...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h3">
        <a href="#request.patch">request.patch</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#request.del-request.delete">request.del / request.delete</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="request-simplified-http-client">
  <h1>
...
<pre><code class="js"><span class="hljs-keyword">var</span> r = request.defaults({<span class="hljs-string">'proxy'</span>:<span class="hljs-string">'http://localproxy.com'</span>})
...
<pre><code class="js"><span class="hljs-keyword">var</span> formData = {
  ...
  <span class="hljs-attr">my_buffer</span>: <span class="hljs-keyword">new</span> Buffer([<span class="hljs-number">1</span>, <span class="hljs-number">2</span>, <span class="hljs-number">3</span>]),
...
form.append(<span class="hljs-string">'my_buffer'</span>, <span class="hljs-keyword">new</span> Buffer([<span class="hljs-number">1</span>, <span class="hljs-number">2</span>, <span class="hljs-number">3</span>]));
...
<pre><code class="js"><span class="hljs-keyword">var</span> username = <span class="hljs-string">'username'</span>,
...
<li>
<p><code>har</code> - A <a href="http://www.softwareishard.com/blog/har-12-spec/#request">HAR 1.2 Request Object</a>, will be processed from HAR format into options overwriting matching values <em>(see the <a href="#support-for-har-1.2.html">HAR 1.2 section</a> for details)</em></p>
</li>
<li>
...
<div class="pilwrap" id="request.put">
  <h3>
    <a href="#request.put" name="request.put" class="pilcrow"></a>
request.put
  </h3>
</div>
...
<div class="pilwrap" id="request.patch">
  <h3>
    <a href="#request.patch" name="request.patch" class="pilcrow"></a>
request.patch
  </h3>
</div>
...
<div class="pilwrap" id="request.post">
  <h3>
    <a href="#request.post" name="request.post" class="pilcrow"></a>
request.post
  </h3>
</div>
...
<div class="pilwrap" id="request.head">
  <h3>
    <a href="#request.head" name="request.head" class="pilcrow"></a>
request.head
  </h3>
</div>
...
<div class="pilwrap" id="request.del-request.delete">
  <h3>
    <a href="#request.del-request.delete" name="request.del-request.delete" class="pilcrow"></a>
...
<div class="pilwrap" id="request.get">
  <h3>
    <a href="#request.get" name="request.get" class="pilcrow"></a>
request.get
  </h3>
</div>
...
<pre><code class="js"><span class="hljs-keyword">var</span> request = request.defaults({<span class="hljs-attr">jar</span>: <span class="hljs-literal">true</span>})
...
<pre><code class="js"><span class="hljs-keyword">var</span> j = request.jar()
...
<pre><code class="js"><span class="hljs-keyword">var</span> FileCookieStore = <span class="hljs-built_in">require</span>(<span class="hljs-string">'tough-cookie-filestore'</span>);
