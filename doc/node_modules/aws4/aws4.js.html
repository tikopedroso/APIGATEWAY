...
RequestSigner.prototype.canonicalHeaders = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  ...
  <span class="hljs-keyword">return</span> <span class="hljs-built_in">Object</span>.keys(headers)
    .filter(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">key</span>) </span>{ <span class="hljs-keyword">return</span> HEADERS_TO_IGNORE[key.toLowerCase()] == <span class="hljs-literal">null</span> })
...
RequestSigner.prototype.signedHeaders = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">var</span> extraHeadersToInclude = <span class="hljs-keyword">this</span>.extraHeadersToInclude,
  ...
  <span class="hljs-keyword">return</span> <span class="hljs-built_in">Object</span>.keys(<span class="hljs-keyword">this</span>.request.headers)
    ...
    .filter(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">key</span>) </span>{
      <span class="hljs-keyword">return</span> extraHeadersToInclude[key] ||
        (HEADERS_TO_IGNORE[key] == <span class="hljs-literal">null</span> &amp;&amp; !extraHeadersToIgnore[key])
    })
    .sort()
    .join(<span class="hljs-string">';'</span>)
}
