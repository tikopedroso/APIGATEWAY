...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\less\\bower.json";
...
<table cellpadding="0" cellspacing="0">
  ...
  <span class="hljs-attr">"main"</span>: <span class="hljs-string">"dist/less.js"</span>,
  <span class="hljs-attr">"ignore"</span>: [
    <span class="hljs-string">"**/.*"</span>,
    <span class="hljs-string">"benchmark"</span>,
    <span class="hljs-string">"bin"</span>,
    <span class="hljs-string">"build"</span>,
    <span class="hljs-string">"gradle"</span>,
    ...
    <span class="hljs-string">"build.gradle"</span>,
    <span class="hljs-string">"gradlew"</span>,
    <span class="hljs-string">"gradlew.bat"</span>,
