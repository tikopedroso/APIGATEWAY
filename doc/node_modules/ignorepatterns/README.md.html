...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\ignorepatterns\\README.md";
  ...
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#common-ignore-patterns">Common Ignore Patterns</a>
      </div>
...
<div class="pilwrap" id="common-ignore-patterns">
  <h1>
    <a href="#common-ignore-patterns" name="common-ignore-patterns" class="pilcrow"></a>
Common Ignore Patterns
  </h1>
</div>
<!-- /TITLE -->
<!-- BADGES/ -->
<p><span class="badge-travisci"><a href="http://travis-ci.com/bevry/ignorepatterns" title="Check this project's build status on TravisCI"><img src="https://img.shields.io/travis/com/bevry/ignorepatterns/master.svg" alt="Travis CI Build Status" /></a></span>
...
<!-- /BADGES -->
<!-- DESCRIPTION/ -->
<p>A regular expression that matches common filenames that we want to ignore</p>
<!-- /DESCRIPTION -->
<!-- INSTALL/ -->
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> ignored = <span class="hljs-built_in">require</span>(<span class="hljs-string">'ignorepatterns'</span>).test(<span class="hljs-string">'.DS_Store'</span>)
<span class="hljs-built_in">console</span>.log(ignored) <span class="hljs-comment">// true</span>
</code></pre>
<!-- HISTORY/ -->
...
<p><a href="https://github.com/bevry/ignorepatterns/blob/master/HISTORY.md#files">Discover the release history by heading on over to the <code>HISTORY.md</code> file.</a></p>
<!-- /HISTORY -->
<!-- CONTRIBUTE/ -->
...
<p><a href="https://github.com/bevry/ignorepatterns/blob/master/CONTRIBUTING.md#files">Discover how you can contribute by heading on over to the <code>CONTRIBUTING.md</code> file.</a></p>
<!-- /CONTRIBUTE -->
<!-- BACKERS/ -->
