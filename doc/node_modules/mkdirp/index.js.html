...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\mkdirp\\index.js";
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">mkdirP</span> (<span class="hljs-params">p, opts, f, made</span>) </span>{
    ...
    <span class="hljs-keyword">var</span> cb = f || <span class="hljs-comment">/* istanbul ignore next */</span> <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{};
    p = path.resolve(p);
    ...
    xfs.mkdir(p, mode, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">er</span>) </span>{
        ...
        <span class="hljs-keyword">switch</span> (er.code) {
            <span class="hljs-keyword">case</span> <span class="hljs-string">'ENOENT'</span>:
                ...
                <span class="hljs-keyword">if</span> (path.dirname(p) === p) <span class="hljs-keyword">return</span> cb(er);
...
is borked.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">            <span class="hljs-keyword">default</span>:
                ...
                <span class="hljs-keyword">catch</span> (err1) <span class="hljs-comment">/* istanbul ignore next */</span> {
