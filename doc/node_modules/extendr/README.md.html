...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules\\extendr\\README.md";
...
<div class="pilwrap" id="extendr">
  <h1>
    <a href="#extendr" name="extendr" class="pilcrow"></a>
extendr
  </h1>
</div>
<!-- /TITLE -->
<!-- BADGES/ -->
<p><span class="badge-travisci"><a href="http://travis-ci.org/bevry/extendr" title="Check this project's build status on TravisCI"><img src="https://img.shields.io/travis/bevry/extendr/master.svg" alt="Travis CI Build Status" /></a></span>
...
<!-- /BADGES -->
<!-- DESCRIPTION/ -->
<p>Utilities for cloning, extending, and de-referencing objects in shallow, deep, and safe ways</p>
<!-- /DESCRIPTION -->
<!-- INSTALL/ -->
...
<pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"module"</span>&gt;</span><span class="javascript">
    <span class="hljs-keyword">import</span> * <span class="hljs-keyword">as</span> pkg <span class="hljs-keyword">from</span> <span class="hljs-string">'//dev.jspm.io/extendr'</span>
...
<p><div class="pilwrap" id="typescript">
  <h3>
    <a href="#typescript" name="typescript" class="pilcrow"></a>
<a href="https://www.typescriptlang.org/" title="TypeScript is a typed superset of JavaScript that compiles to plain JavaScript. ">TypeScript</a>
  </h3>
</div></p>
<p>This project provides its type information via inline <a href="http://usejsdoc.org" title="JSDoc is an API documentation generator for JavaScript, similar to Javadoc or phpDocumentor">JSDoc Comments</a>. To make use of this in <a href="https://www.typescriptlang.org/" title="TypeScript is a typed superset of JavaScript that compiles to plain JavaScript. ">TypeScript</a>, set your <code>maxNodeModuleJsDepth</code> compiler option to <code>5</code> or thereabouts. You can accomlish this via your <code>tsconfig.json</code> file like so:</p>
<pre><code class="json">{
  <span class="hljs-attr">"compilerOptions"</span>: {
    <span class="hljs-attr">"maxNodeModuleJsDepth"</span>: <span class="hljs-number">5</span>
  }
}
</code></pre>
<!-- /INSTALL -->
...
<p><a href="http://master.extendr.bevry.surge.sh/docs/">Complete API Documentation.</a></p>
<!-- HISTORY/ -->
...
<p><a href="https://github.com/bevry/extendr/blob/master/HISTORY.md#files">Discover the release history by heading on over to the <code>HISTORY.md</code> file.</a></p>
<!-- /HISTORY -->
<!-- CONTRIBUTE/ -->
...
<p><a href="https://github.com/bevry/extendr/blob/master/CONTRIBUTING.md#files">Discover how you can contribute by heading on over to the <code>CONTRIBUTING.md</code> file.</a></p>
<!-- /CONTRIBUTE -->
<!-- BACKERS/ -->
