...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#qs-version-badge21">qs [![Version Badge][2]][1]</a>
      </div>
      ...
      <div class="heading h2">
        <a href="#qs-for-enterprise">qs for enterprise</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="qs-version-badge21">
  <h1>
    <a href="#qs-version-badge21" name="qs-version-badge21" class="pilcrow"></a>
qs <sup>[![Version Badge][2]][1]</sup>
  </h1>
</div>
<p><a href="https://github.com/ljharb/qs/actions"><img src="https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/ljharb/qs" alt="github actions"></a>
<a href="https://app.codecov.io/gh/ljharb/qs/"><img src="https://codecov.io/gh/ljharb/qs/branch/main/graphs/badge.svg" alt="coverage"></a>
<a href="https://david-dm.org/ljharb/qs"><img src="https://david-dm.org/ljharb/qs.svg" alt="dependency status"></a>
<a href="https://david-dm.org/ljharb/qs#info=devDependencies"><img src="https://david-dm.org/ljharb/qs/dev-status.svg" alt="dev dependency status"></a>
<a href="LICENSE.html"><img src="https://img.shields.io/npm/l/qs.svg" alt="License"></a>
<a href="https://npm-stat.com/charts.html?package=qs"><img src="https://img.shields.io/npm/dm/qs.svg" alt="Downloads"></a></p>
...
<pre><code class="javascript"><span class="hljs-keyword">var</span> encoded = qs.stringify({ <span class="hljs-attr">a</span>: { <span class="hljs-attr">b</span>: <span class="hljs-string">'c'</span> } }, { <span class="hljs-attr">encoder</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">str, defaultEncoder, charset, type</span>) </span>{
    <span class="hljs-keyword">if</span> (type === <span class="hljs-string">'key'</span>) {
        <span class="hljs-keyword">return</span> <span class="hljs-comment">// Encoded key</span>
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (type === <span class="hljs-string">'value'</span>) {
        <span class="hljs-keyword">return</span> <span class="hljs-comment">// Encoded value</span>
    }
}})
</code></pre>
<p>The type argument is also provided to the decoder:</p>
<pre><code class="javascript"><span class="hljs-keyword">var</span> decoded = qs.parse(<span class="hljs-string">'x=z'</span>, { <span class="hljs-attr">decoder</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">str, defaultDecoder, charset, type</span>) </span>{
    <span class="hljs-keyword">if</span> (type === <span class="hljs-string">'key'</span>) {
        <span class="hljs-keyword">return</span> <span class="hljs-comment">// Decoded key</span>
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (type === <span class="hljs-string">'value'</span>) {
        <span class="hljs-keyword">return</span> <span class="hljs-comment">// Decoded value</span>
    }
}})
</code></pre>
...
<div class="pilwrap" id="qs-for-enterprise">
  <h2>
    <a href="#qs-for-enterprise" name="qs-for-enterprise" class="pilcrow"></a>
qs for enterprise
  </h2>
</div>
